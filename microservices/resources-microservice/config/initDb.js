...
function createTable() {
    return new Promise((resolve, reject) => {
        ...
        con.connect(function (err) {
            ...
            var sql = "CREATE TABLE resources (id INT AUTO_INCREMENT PRIMARY KEY,title VARCHAR(255) NOT NULL,summary VARCHAR(255),description VARCHAR(2000),tags VARCHAR(255),link VARCHAR(255) NOT NULL,posted_by VARCHAR(255),is_book BOOLEAN DEFAULT FALSE,is_online_book BOOLEAN DEFAULT FALSE,is_course BOOLEAN DEFAULT FALSE,is_framework BOOLEAN DEFAULT FALSE,is_visual_programming_language BOOLEAN DEFAULT FALSE,is_sound_programming_language BOOLEAN DEFAULT FALSE,is_web_programming_library BOOLEAN DEFAULT FALSE,is_hardware BOOLEAN DEFAULT FALSE,is_video BOOLEAN DEFAULT FALSE,is_tutorial BOOLEAN DEFAULT FALSE,is_machine_learning BOOLEAN DEFAULT FALSE,is_blog BOOLEAN DEFAULT FALSE,image_src VARCHAR(500),created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);";
